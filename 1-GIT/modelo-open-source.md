# Modelo para trabajar con el repo de neoland con github:
...
3. Crear una carpeta con tu nombre. En esta carpeta subirás todos tus ejercicios
4. Crear un Readme.md con tu presentación
5. Subirlo a tu repositorio remoto (git add, commit & push)
6. Enviar tus cambios al repositorio principal, es decir, hacer un pull request. [Tutorial](https://docs.github.com/es/github/collaborating-with-pull-requests/proposing-changes[…]r-work-with-pull-requests/creating-a-pull-request-from-a-fork)
